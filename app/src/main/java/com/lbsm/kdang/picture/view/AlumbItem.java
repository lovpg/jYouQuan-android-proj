...
public class AlumbItem extends LinearLayout{
    ...
    public void init(){
        ...
        foldres = KDangApplication.getInstance().localImageHelper.folders;
    }
    ...
    public void setContent(String name,String folder){
        ...
        if(localFiles != null && localFiles.size() > 0){
            ...
            ImageLoader.getInstance().displayImage(url,alumbImage,
                    KDangApplication.getInstance().options,new ImageLoadingListener(){
