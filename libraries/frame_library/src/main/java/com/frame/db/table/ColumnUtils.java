...
import com.frame.db.annotation.Check;
import com.frame.db.annotation.Column;
import com.frame.db.annotation.Finder;
import com.frame.db.annotation.Foreign;
import com.frame.db.annotation.Id;
import com.frame.db.annotation.NotNull;
import com.frame.db.annotation.Transient;
import com.frame.db.annotation.Unique;
import com.frame.db.converter.ColumnConverter;
import com.frame.db.converter.ColumnConverterFactory;
import com.frame.db.sqlite.FinderLazyLoader;
import com.frame.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.frame.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.frame.db.table.Finder finderColumn) {
