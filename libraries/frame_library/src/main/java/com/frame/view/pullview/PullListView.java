 ...
 * 
 * <p>You need to call  when refresh thread finished,<br>
 * Similarly, You also need to call  when load thread finished.<br>
 * 
...
public class PullListView extends ListView implements IPullView, AbsListView.OnScrollListener {
	...
	public PullFooterView mFooterView;
	 ...
	 * <p>{@link com.frame.view.pullview.PullListView.LoadMode#PULL_TO_LOAD} pull-to-loadmore<br>
	 * You need to pull to load more data<br><br>
	 * <p>{@link com.frame.view.pullview.PullListView.LoadMode#AUTO_LOAD} auto-loadmore<br>
		...
		if(scrollState == SCROLL_STATE_IDLE && mLastItemIndex == mTotalItemCount && mState == IDEL) {
			if(mLoadMoreable) {
				...
				if(mShowNoMoreDataTips) {
					onFootLoad(R.string.pull_view_end);
				}
			}
		}
		if(null != mScrollListener) {
	...
	public void onFootLoad(int text) {
		mFooterView.setPadding(0, 20, 0, 20);
		mFooterView.setArrowVisibility(View.GONE);
	 ...
	 * <p>can use value is {@link com.frame.view.pullview.PullListView.LoadMode#AUTO_LOAD} and {@link com.frame.view.pullview.PullListView.LoadMode#PULL_TO_LOAD}<br>
	 * default is {@link com.frame.view.pullview.PullListView.LoadMode#AUTO_LOAD}
	 * @param mode
	 * @see {@link com.frame.view.pullview.PullListView.LoadMode}
	 */
	 ...
	 * <p>The value of {@link #mLastRefreshTime} initialized to the time when create {@link com.frame.view.pullview.PullListView} object.<br>
